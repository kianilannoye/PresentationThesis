...
\begin{frame}{System}
	  ...
	  \begin{center}
	  	...
	  	\node<2>[align=center,red,font={\Large\bfseries}] at (1.1,4.2) {\includegraphics[width=0.2\textwidth]{figures/mongoDB.png}};
	  	\node<2>[align=center,red,font={\large\bfseries}] at (3.2,2.4) {Jax-RS(Java)};
	  	\end{tikzpicture}
	  \end{center}	
\end{frame}
