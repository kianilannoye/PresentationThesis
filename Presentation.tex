...
\begin{frame}{System}
	  ...
	  \begin{center}
	  	...
	  	\node<2>[south west,inner sep=0] at (1.1,4.2) {\includegraphics[width=0.2\textwidth]{figures/mongoDB.png}};
	  	\node<2>[south west,inner sep=0,red,font={\large\bfseries}] at (3.2,2.4) {Jax-RS(Java)};
	  	\end{tikzpicture}
	  \end{center}	
\end{frame}
